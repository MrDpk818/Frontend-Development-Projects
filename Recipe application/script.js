    ...
    <div class="col">
        <div class="card mb-4 rounded-3 shadow-sm border-primary">
            ...
            <div class="card-body">
                ...
                <button class="btn btn-md btn-outline-danger " aria-label="Delete ${item.name}" value="${item.id}">Delete Recipe</button>
            </div>
        </div>
    </div>
...
function loadinitialUI(){
    ...
    const tempRecipe = JSON.parse(tempLocalStorage);
    listItems.push(...tempRecipe);
    recipeContainer.dispatchEvent(new CustomEvent('refreshRecipes'));
